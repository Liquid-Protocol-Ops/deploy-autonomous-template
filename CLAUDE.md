...
The agent template is self-contained; off-chain services (status APIs, schedulers, fee-claim watchers, lifecycle automation) may run separately and are not required for an agent to operate.
