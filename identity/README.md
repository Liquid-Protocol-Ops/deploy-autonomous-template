...
- **At deploy time** (CLI soul phase): author or fork [[identity/SOUL.genesis]], [[identity/STYLE.genesis]], [[identity/influences]]. Seed [[identity/examples/good-outputs]] and [[identity/examples/bad-outputs]] with 5–10 entries each.
